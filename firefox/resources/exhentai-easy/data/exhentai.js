...
function loginToEhResult(r) {
    if(r == null || r.text == null) {
        alert('An unknown error (#1) occured while attempting to login to ExHentai. Please report this to s0beit on http://haruhichan.com!');
        return;
    }
...
$(function() {
    ...
    $('body').html(
        "<div align=\"center\">" + 
            "<font style=\"color:red;\">ExHentai Easy</font> for Firefox by <a href=\"http://haruhichan.com\">Haruhichan</a>!<br /><br />" + 
